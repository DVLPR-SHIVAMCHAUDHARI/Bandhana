...
List list = [
  ...
  },
  {
    ...
    "screen": ProfileSetupScreen(type: "edit", age: ""),
    "title": "Edit Profile Setup",
  },
  {
    "icon": Icons.family_restroom, // family details
    "screen": FamilyDetailsScreen(type: "edit"),
  ...
  },
  {
    ...
    "screen": BlocProvider(
      ...
      child: BasicCompablityScreen1(type: "edit"),
    ),
  ...
  },
  {
    ...
    "screen": BlocProvider(
      create: (context) => UserPreferencesBloc(),
      child: BasicCompablityScreen2(type: "edit"),
    ),
