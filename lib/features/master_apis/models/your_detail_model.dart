...
class YourDetailModel {
  ...
  YourDetailModel({this.profileDetails, this.profileSetup, this.patnerLifeStylePreferences, this.familyDetails, this.profileDocument, this.partnerExpectations, this.error, this.code});

  YourDetailModel.fromJson(Map<String, dynamic> json) {
    ...
    if(json["profile_document"] is Map) {
      profileDocument = json["profile_document"] == null ? null : ProfileDocument.fromJson(json["profile_document"]);
    }
    if(json["partner_expectations"] is Map) {
      partnerExpectations = json["partner_expectations"] == null ? null : PartnerExpectations.fromJson(json["partner_expectations"]);
    }
  ...
  static List<YourDetailModel> fromList(List<Map<String, dynamic>> list) {
    return list.map(YourDetailModel.fromJson).toList();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if(profileDocument != null) {
      _data["profile_document"] = profileDocument?.toJson();
    }
    if(partnerExpectations != null) {
      _data["partner_expectations"] = partnerExpectations?.toJson();
    }
    _data["error"] = error;
    _data["code"] = code;
    return _data;
...
class PartnerExpectations {
  int? id;
  int? caste;
  int? income;
  int? userId;
  List<Educaion>? educaion;
  int? religion;
  String? casteName;
  ...
  int? heightRange1;
  int? heightRange2;
  List<WorkLocation1>? workLocation1;
  dynamic workLocation2;
  dynamic workLocation3;
  List<NativeLocation1>? nativeLocation1;
  dynamic nativeLocation2;
  dynamic nativeLocation3;
  String? otherExpectations;

  PartnerExpectations({this.id, this.caste, this.income, this.userId, this.educaion, this.religion, this.casteName, this.profession, this.ageRange1, this.ageRange2, this.incomeName, this.religionName, this.heightRange1, this.heightRange2, this.workLocation1, this.workLocation2, this.workLocation3, this.nativeLocation1, this.nativeLocation2, this.nativeLocation3, this.otherExpectations});

  PartnerExpectations.fromJson(Map<String, dynamic> json) {
    if(json["id"] is int) {
      id = json["id"];
    }
    ...
    if(json["educaion"] is List) {
      educaion = json["educaion"] == null ? null : (json["educaion"] as List).map((e) => Educaion.fromJson(e)).toList();
    }
    ...
    if(json["profession"] is List) {
      profession = json["profession"] == null ? null : (json["profession"] as List).map((e) => Profession.fromJson(e)).toList();
    }
    if(json["age_range_1"] is int) {
      ageRange1 = json["age_range_1"];
    }
    if(json["age_range_2"] is int) {
      ageRange2 = json["age_range_2"];
    }
    if(json["income_name"] is String) {
      incomeName = json["income_name"];
    }
    if(json["religion_name"] is String) {
      religionName = json["religion_name"];
    }
    if(json["height_range_1"] is int) {
      heightRange1 = json["height_range_1"];
    }
    if(json["height_range_2"] is int) {
      heightRange2 = json["height_range_2"];
    }
    if(json["work_location_1"] is List) {
      workLocation1 = json["work_location_1"] == null ? null : (json["work_location_1"] as List).map((e) => WorkLocation1.fromJson(e)).toList();
    }
    workLocation2 = json["work_location_2"];
    workLocation3 = json["work_location_3"];
    if(json["native_location_1"] is List) {
      nativeLocation1 = json["native_location_1"] == null ? null : (json["native_location_1"] as List).map((e) => NativeLocation1.fromJson(e)).toList();
    }
    nativeLocation2 = json["native_location_2"];
    nativeLocation3 = json["native_location_3"];
    if(json["other_expectations"] is String) {
      otherExpectations = json["other_expectations"];
    }
  }

  static List<PartnerExpectations> fromList(List<Map<String, dynamic>> list) {
    return list.map(PartnerExpectations.fromJson).toList();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if(educaion != null) {
      _data["educaion"] = educaion?.map((e) => e.toJson()).toList();
    }
    _data["religion"] = religion;
    _data["caste_name"] = casteName;
    if(profession != null) {
      _data["profession"] = profession?.map((e) => e.toJson()).toList();
    }
    _data["age_range_1"] = ageRange1;
    _data["age_range_2"] = ageRange2;
    _data["income_name"] = incomeName;
    _data["religion_name"] = religionName;
    _data["height_range_1"] = heightRange1;
    _data["height_range_2"] = heightRange2;
    if(workLocation1 != null) {
      _data["work_location_1"] = workLocation1?.map((e) => e.toJson()).toList();
    }
    _data["work_location_2"] = workLocation2;
    _data["work_location_3"] = workLocation3;
    if(nativeLocation1 != null) {
      _data["native_location_1"] = nativeLocation1?.map((e) => e.toJson()).toList();
    }
    _data["native_location_2"] = nativeLocation2;
    _data["native_location_3"] = nativeLocation3;
    _data["other_expectations"] = otherExpectations;
    return _data;
  }
}

class NativeLocation1 {
  int? id;
  String? districtName;

  NativeLocation1({this.id, this.districtName});

  NativeLocation1.fromJson(Map<String, dynamic> json) {
    if(json["id"] is int) {
      id = json["id"];
    }
  ...
  static List<NativeLocation1> fromList(List<Map<String, dynamic>> list) {
    return list.map(NativeLocation1.fromJson).toList();
  }
...
class WorkLocation1 {
  ...
  WorkLocation1({this.id, this.districtName});

  WorkLocation1.fromJson(Map<String, dynamic> json) {
    if(json["id"] is int) {
      id = json["id"];
    }
    if(json["district_name"] is String) {
  ...
  static List<WorkLocation1> fromList(List<Map<String, dynamic>> list) {
    return list.map(WorkLocation1.fromJson).toList();
  }
...
class Profession {
  ...
  static List<Profession> fromList(List<Map<String, dynamic>> list) {
    return list.map(Profession.fromJson).toList();
  }
...
class Educaion {
  ...
  Educaion({this.id, this.education});

  Educaion.fromJson(Map<String, dynamic> json) {
    if(json["id"] is String) {
      id = json["id"];
    }
  ...
  static List<Educaion> fromList(List<Map<String, dynamic>> list) {
    return list.map(Educaion.fromJson).toList();
  }
...
class ProfileDocument {
  ...
  String? casteCertificte;
  String? aadhaarOrPanUrl;
  String? selfieWithIdUrl;
  String? casteCertificteUrl;

  ProfileDocument({this.id, this.userId, this.aadhaarOrPan, this.liveSelfieUrl, this.casteCertificte, this.aadhaarOrPanUrl, this.selfieWithIdUrl, this.casteCertificteUrl});
  ...
  ProfileDocument.fromJson(Map<String, dynamic> json) {
    ...
    if(json["aadhaar_or_pan"] is String) {
      aadhaarOrPan = json["aadhaar_or_pan"];
    }
    if(json["live_selfie_url"] is String) {
      liveSelfieUrl = json["live_selfie_url"];
    }
    if(json["caste_certificte"] is String) {
      casteCertificte = json["caste_certificte"];
    }
    if(json["aadhaar_or_pan_url"] is String) {
      aadhaarOrPanUrl = json["aadhaar_or_pan_url"];
    }
    if(json["selfie_with_id_url"] is String) {
      selfieWithIdUrl = json["selfie_with_id_url"];
    }
    if(json["caste_certificte_url"] is String) {
      casteCertificteUrl = json["caste_certificte_url"];
    }
  }

  static List<ProfileDocument> fromList(List<Map<String, dynamic>> list) {
    return list.map(ProfileDocument.fromJson).toList();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data["id"] = id;
    _data["user_id"] = userId;
    _data["aadhaar_or_pan"] = aadhaarOrPan;
    _data["live_selfie_url"] = liveSelfieUrl;
    _data["caste_certificte"] = casteCertificte;
    _data["aadhaar_or_pan_url"] = aadhaarOrPanUrl;
    _data["selfie_with_id_url"] = selfieWithIdUrl;
    _data["caste_certificte_url"] = casteCertificteUrl;
    return _data;
  }
}
